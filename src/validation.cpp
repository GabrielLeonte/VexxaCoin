...
#if defined(NDEBUG)
# error "Vexxacoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Vexxacoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s VXC additional fees, %d delta bytes\n",
