...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s vexxacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  vexxacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vexxacoin transaction") + "\n" +
              "  vexxacoin-tx [options] -create [commands]   " + _("Create hex-encoded vexxacoin transaction") + "\n" +
              "\n";
