...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/vexxacoin-project/vexxacoin>";
    const std::string URL_WEBSITE = "<https://vexxacoin.org>";
